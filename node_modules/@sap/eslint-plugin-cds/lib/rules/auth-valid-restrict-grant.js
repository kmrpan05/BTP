...
function extractActions (e, csn) {
  const getActions = /** @param {any} e */ e => Object.keys(e.actions ?? {})
  const queue = [e]
  const actions = []
  while (queue.length) {
    ...
    if (isJoin(entity)) {
      ...
      queue.push(...entity.query.SET.args.map(/** @param {any} e */ e => ({query: e}) ))
    }
  }
  return actions
}

const TYPICAL_ISSUES = /** @type {Record<string, string>} */(Object.assign(Object.create(null), {
  any: '*'
}))
