...
const isSapCds = /** @param {any} name */ name => Boolean(name?.match(/^\W*@sap\/cds\W*$/))

/**
 * @param {{ name: any, type: VariableType, isCdsVariable: any, original: any }} param
 */
...
class CdsHandlerRule {
  ...
  asESLintVisitor() {
    ...
    const visitors = /** @type {Record<string, any>} */({})
    while (proto && proto !== Object.prototype) {
      Object.getOwnPropertyNames(proto)
        .filter(key => typeof (/** @type {any} */(this))[key] === 'function' && /^[A-Z]/.test(key))
        .forEach(key => {
          visitors[key] = (/** @type {any} */(this))[key].bind(this)
        })
